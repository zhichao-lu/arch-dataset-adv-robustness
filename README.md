...
2. Download dataset [`nares.txz`](https://github.com/zhichao-lu/arch-dataset-adv-robustness/releases/download/v1.0/nares.txz) and put the decompressed file `cifar10.jsonl` to path `data/`.
